...
filename = '20180115_sla.txt';

fid = fopen(filename, 'r');

sla_20180115 = textscan(fid, '%s %f %f %f %f','headerLines', 10,'Delimiter',',');

fclose(fid);

sla_20180115 = cell2mat(sla_20180115(3:5));
% sla_20180115的行資料 : xlon ylat sla
%% Set variables
xlon = sla_20180115(:,1);
ylat = sla_20180115(:,2);
sla = sla_20180115(:,3);  % sla
...
hold off;
title('20180115_sla','Interpreter','none')
print('W12_hw01_20180115_sla','-dpng')
...
kuroshio_avg_spd = nanmean(spd(spd>=0.3)); % 計算黑潮流軸平均流速
...
xlabel({['Flow field mean speed : ' avg_spd_str(1:5) ' (m/s)'];...
    ...
    ,'color','b','fontsize',10);
title('20180115_sla_current_speed','Interpreter','none')
print('W12_hw02_20180115_sla','-dpng')