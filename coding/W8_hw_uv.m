%%
% help m_map
%% 載入資料 uv_bt_90_120_00781035.txt
% 第1題 : 
% Using the data “cr2247001_000000.LTA”, output
% the current velocities from the 90th ensemble to
% the 120th ensemble, after removing the
% “bottom-track” ship velocities. Show the ship
% track and current velocities on a map.
% 第2題 : 
% Compare the current velocities to those after
% removing the “GPS” ship velocities.
...
filename = 'uv_bt_90_120_00781035.txt';
ds1 = datastore(filename); %載入第1筆資料data1，存放到ds1 (type : TabularTextDatastore)
uv_bt_90_120_00781035 = read(ds1); % 讀取第1筆資料ds1，存放到uv_bt_90_120_00781035 (type : table)
cd('C:\Users\user\Google 雲端硬碟\洋流觀測分析_1082\coding')
%% 航行軌跡經緯度資料(uv_bt_90_120_00781035.txt)
uv_bt_90_120_00781035(1:2,:) = []; % 刪除前兩行的多於資料
first_lat_bt_90_120 = str2double(uv_bt_90_120_00781035.FLat);
% str2double : 將這裡的 cell array 轉換為 Double-precision array
first_lon_bt_90_120 = str2double(uv_bt_90_120_00781035.FLon);

last_lat_bt_90_120 = str2double(uv_bt_90_120_00781035.LLat);
% str2double : 將這裡的 cell array 轉換為 Double-precision array
last_lon_bt_90_120 = str2double(uv_bt_90_120_00781035.LLon);

avg_lat_bt_90_120 = (first_lat_bt_90_120 + last_lat_bt_90_120)/2;
avg_lon_bt_90_120 = (first_lon_bt_90_120 + last_lon_bt_90_120)/2;

u_bt_90_120 = str2double(uv_bt_90_120_00781035.Eas);
v_bt_90_120 = str2double(uv_bt_90_120_00781035.Nor);
