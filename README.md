 ...
 * 關鍵字
   ...
   >reef coast 礁岩海岸
   >salt marsh 鹽沼
   >backshore 後濱：沙灘乾燥的區域，只有當最高潮位和嚴重的暴風時才會被淹沒
...
### [第2周](https://) 海洋三大物理量 [02_basic_parameters](https://tronclass.ntou.edu.tw/course/56408/learning-activity/full-screen#/128647)
#### KeyWords
* Temperature (溫度)
* salinity (鹽度)
* pressure (壓力)
...
### [第8周](https://drive.google.com/open?id=1FaU1eUVHVJIjFKvTCMep_nidM0RxGNWI) 海洋表面環流 - 艾克曼流 [07_General global ocean circulation_P1_Ekman](https://tronclass.ntou.edu.tw/course/56408/learning-activity/full-screen#/140680)
#### KeyWords
* 
#### Links
...
## [海洋動力學_1091](/WsLAqpahQGOwQ184MRkwtg)


---
## [海洋系學術活動](http://www.mei.ntou.edu.tw/files/11-1025-3748.php?Lang=zh-tw)
- [x] 1. 一般海水何以多呈藍色？

  >因水分子對光的散射強度，短波長較長波長為強，故海水大多呈藍色。
- [x] 2. 海水的溫度、鹽度、壓力對海水中聲音傳播速度之影響為何？
  >海水中聲音傳播速度隨海水溫度、鹽度、壓力的增加而增加。
- [x] 3. 海洋中有所謂的「聲傳通道」(SOFAR channel)，請解釋此現象。
  >SOFAR是SOund Fixing And Ranging之縮寫。 聲發聲道（SOFAR channel），海洋中因特殊的聲速分布所導致聲波傳播路徑的改變所形成之波導環境，可將聲波能量限制在固定的水層內而達到遠距離傳播的效果。

- [x] 4. 何謂溫鹽圖(T-S diagram)？其用途為何？

  >將在海洋中不同地點不同深度所量測的溫度、鹽度繪圖，即為溫鹽圖。其用途可作為不同水團的判別。
- [x] 5. 海洋學對海水密度常用簡化形式表示，為什麼？

   >因海水密度的變化很小，為了方便，將密度(kg/m^3)減去1000，此即為海水密度的簡化型。

- [x] 6. 試說明海洋中水溫的典型垂直分佈(可繪圖輔助說明)。

   >典型的海水溫度垂直分佈為上層為溫度均勻的混合層(mixed Layer)，其下為一溫度隨深度增加而快速降低的溫躍層(Thermocline)，然後溫度隨深度變化極小的深層(Deep Ocean)。

- [x] 7. 何謂混合層(Mixed Layer)?

   >上層海水(從表面約到25~200m的深度)由於波浪的作用使海水混合均勻，水溫與海表面的水溫相近，這一層海水稱為混合層。其溫度與厚度會隨季節而改變，尤其是在中緯度海域最明顯。

- [x] 8. 試略述影響海水密度變化的各種因素。

  >海水密度受海水的溫度、鹽度、壓力的影響。密度隨溫度的減小、鹽度的增加、及壓力的增加而變大。

- [x] 9. 何謂正壓水層？何謂斜壓水層？

   >海水隨深度變化的等密度線與等壓力線平行，稱為正壓水層。
   >若等密度線與等壓力線交叉，則為斜壓水層。

- [x] 10. 地球自轉偏向力對於海流所發生的作用為何？

    >(1)使大洋的西側海流較東側為強
    >(2)會使海流與風吹的方向，在北半球往右偏、南半球往左偏。
- [x] 11. 何謂溫鹽環流(Thermohaline circulation)?其特徵為何?

    >溫鹽環流是指海水因溫度或鹽度變化而改變密度，因而產生的海水運動。其特徵是，在表層海水因密度增大而下沈到中或底層，然後再往水平方向流動。

- [x] 12. 試略述造成海洋溫鹽環流的原因?

  >表面海水的密度增加。可能是直接受冷的結果，也可能是海水結冰排出的鹽分使未結冰的海水密度增加。

- [x] 13. 試略述台灣附近之海流。

    >台灣的東側海域有黑潮自南往北流，台灣海峽夏季有南海暖流自南往北流，冬季則有大陸沿岸冷水自北往南流，而當東北季風減弱時則黑潮支流會流入台灣海峽沿澎湖水道北上。

- [x] 14. 為何大洋環流的流速在大洋的西側較東側為強？

    >因地球自轉科氏力。
- [x] 15. 何謂[西邊強化](https://www.google.com/search?q=%E8%A5%BF%E9%82%8A%E5%BC%B7%E5%8C%96&oq=%E8%A5%BF%E9%82%8A%E5%BC%B7%E5%8C%96&aqs=chrome..69i57.360j0j9&sourceid=chrome&ie=UTF-8)([Western Intensification](https://www.google.com/search?q=Western+Intensification&oq=Western+Intensification&aqs=chrome..69i57&sourceid=chrome&ie=UTF-8))海流，並舉二個最具代表性的海流名稱為例。

    >因地球自轉科氏力的作用，使大洋環流的西邊形成強而窄的海流，這現象稱為西邊強化。這現象在北太平洋有黑潮，而在北大西洋的西邊則有灣流。
...
- [x] 30. 為何海岬(Cape)地區被海水侵蝕的速率較海灣(Bay)地區快?
    ...
    >波浪的折射，在海岬地區能量聚集，沖擊力大增，而在海灣處能量散發，沖擊力大減。
...
- [x] 43. 如何推算海嘯之傳送速度？
    ...
    >海嘯之傳送速度v與水深h有關，其關係為v=$sqrt(gh)$，其中g為重力加速度。因此海嘯在深海的傳播速度很快，以水深4000公尺而言，其速度約為每秒200公尺，相當於噴射機的速度。
...
* **臺灣海洋科技研究中心TORI**
  ...
  [ROV操作教育訓練 2017 年 08 月 24 日 ](https://www.tori.narl.org.tw/Home/info/466)
...
* **中山大學**
  ...
  [中山大學,海下物所 水下機電實驗室,四軸水下機械手臂](https://www.youtube.com/watch?time_continue=12&v=tynYabwRC9Y)
